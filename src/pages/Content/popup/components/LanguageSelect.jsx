...
export default function LanguageDropdown({ value, handleChange }) {
 ...
 const handleLanguageSelect = async (lang) => {
  ...
  const languageFlagMap = {
    ...
    Gujarati: "https://flagcdn.com/in.svg",
